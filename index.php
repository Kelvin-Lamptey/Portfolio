...
<head>
    ...
    <!-- SEO Meta Tags -->
    <meta name="description" content="Kelvin Lamptey - Computer Science Student and CTO of KENOL Tech Company specializing in fullstack development, technical leadership, and cross-platform applications">
	...
	<meta property="og:title" content="Kelvin Lamptey - Student & CTO at KENOL Tech | Fullstack Developer"/> <!-- title shown in the actual shared post -->
	<meta property="og:description" content="Computer Science student and Chief Technology Officer at KENOL Tech Company specializing in Node.js, Django, React, Flutter, and modern web technologies" /> <!-- description shown in the actual shared post -->
    ...
    <!-- Webpage Title -->
    <title>Kelvin Lamptey - Student & CTO at KENOL Tech | Fullstack Developer</title>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        <h1 class="h1-large">Student. Developer. CTO at KENOL Tech. Building the future, one line at a time.</h1>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-container first">
                        ...
                        <p>I'm a Computer Science student and Chief Technology Officer at <a href="https://kenol.tech" target="_blank" rel="noopener" class="blue no-line">KENOL Tech Company</a> with a passion for building innovative solutions. I balance academic excellence with real-world technology leadership, specializing in fullstack development across web, mobile, and desktop platforms using Node.js, Django, Flask, Vue, React, Go, Flutter, and C++.</p>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-4">
                    <div class="text-container second">
                        ...
                        <p>Leading technical strategy and development at <a href="https://kenol.tech" target="_blank" rel="noopener" class="blue no-line">KENOL Tech Company</a>, architecting scalable solutions and managing cross-functional engineering teams.</p>
                        <div class="time">2025 - Present</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading">As a student and CTO at KENOL Tech Company, I combine academic knowledge with practical experience in fullstack development, technical leadership, and system architecture. My expertise spans multiple domains from modern web frameworks to mobile and desktop development.</p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    <div class="text-box">
                        ...
                        <p>Leading development teams as CTO at KENOL Tech Company, making strategic technology decisions, and mentoring developers. Experience in agile methodologies, code reviews, and establishing best practices.</p>
                    </div> <!-- end of text-box -->
                </div> <!-- end of col -->
                <div class="col-lg-4">
                    <div class="text-box">
                ...
                <div class="row">
                    <div class="col-lg-12">     
                        ...
                        <div class="text-container">
                            ...
                            <p>Balancing academic rigor with practical CTO experience at KENOL Tech Company gives me a unique perspective on both cutting-edge research and real-world implementation challenges.</p>
                            ...
                            <p>As CTO at KENOL Tech, I lead cross-functional teams, make architectural decisions, and ensure code quality through reviews and mentorship. I believe in clear communication and iterative development.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading">A selection of academic, personal, and professional projects from my work at KENOL Tech and beyond, showcasing my range from banking platforms to real-time communication systems. Each project represents a unique challenge in architecture, scalability, or user experience.</p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    How do you balance being a student and CTO at KENOL Tech?
                                </button>
                            </div>
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body">
                                    Time management and prioritization are key. My academic studies inform my technical decisions at KENOL Tech, while my CTO experience enriches my understanding of real-world applications. Both roles complement each other perfectly, allowing me to bring cutting-edge research into production environments.
                                </div>
                            </div>
                        </div>
                        <div class="card">
